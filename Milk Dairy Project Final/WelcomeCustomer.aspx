<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WelcomeCustomer.aspx.cs" Inherits="WelcomeCustomer" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<link href="CustomerStyleSheet.css" rel="stylesheet" type="text/css" />
...
<head runat="server">
	...
	<link rel="stylesheet" href="Customer.css3prj_files/css3menu1/style.css" type="text/css" /><style type="text/css">._css3m{display:none}</style>
...
<ul id="css3menu1" class="topmenu">
	...
	<li class="topfirst"><a href="#" style="width:433px;height:24px;line-height:24px;">View</a>
     <ul>
    <li ><a href="SpecificCustomer.aspx">View Details</a></li>
   
    <li ><a href="Welcome.aspx">Exit</a></li></ul></li>
	<li class="topmenu"><a href="#" style="width:433px;height:24px;line-height:24px;"><span>Sales Details</span></a>
	<ul>
		<li class="subfirst"><a href="#"><span>View </span></a>
		<ul>
			<li class="subfirst"><a href="AllSales.aspx">All</a></li>
			<li><a href="SpecificSale.aspx">Specific</a></li>
		</ul></li>
	</ul></li>
	<li class="toplast"><a href="#" style="width:434px;height:24px;line-height:24px;"><span>Receipt</span></a>
	<ul>
		<li class="subfirst"><a href="#"><span>View </span></a>
		<ul>
			<li class="subfirst"><a href="AllReceipt.aspx">All</a></li>
			<li><a href="SpecificReceipt.aspx">Specific</a></li>
		</ul></li>
	</ul></li>
</ul><p class="_css3m"><a href="http://css3menu.com/">mobile menu</a> by Css3Menu.com</p>
