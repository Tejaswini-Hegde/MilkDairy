...
public partial class CaptchaDemo : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
         Bitmap objBitmap = new Bitmap(130, 100);  
            ...
            Font objFont = new Font("Bookman Old Style", 18, FontStyle.Bold);  
            //Draw the image for captcha  
            objGraphics.DrawString(captchaText, objFont, Brushes.Black, 10, 20);  
