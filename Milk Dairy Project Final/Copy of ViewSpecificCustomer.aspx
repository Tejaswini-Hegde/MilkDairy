<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Copy of ViewSpecificCustomer.aspx.cs" Inherits="ViewSpecificCustomer" %>
...
<body style="height: 666px; width: 1408px">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:Panel ID="Panel1" runat="server" BackImageUrl="~/22738090.jpg" 
        ...
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Large" 
            Height="37px" style="margin-left: 167px" Text="Enter Aadhar Number" 
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" BackColor="White" 
            ...
            style="margin-left: 170px" Width="254px">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="select * from customermaster where cAadhar=?">
            <SelectParameters>
                <asp:ControlParameter ControlID="txtAadhar" Name="?" PropertyName="Text" />
            </SelectParameters>
        </asp:SqlDataSource>
    </asp:Panel>
    <br />
