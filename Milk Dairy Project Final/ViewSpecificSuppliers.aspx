<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewSpecificSuppliers.aspx.cs" Inherits="_Default" %>
...
<body style="height: 697px">
    ...
    <asp:ImageButton ID="ImageButton2" runat="server" 
        ...
        Width="602px">
            ...
            <asp:TextBox ID="txtSID" runat="server" AutoPostBack="True" Height="36px" 
            ...
            <asp:Button ID="cmdShow" runat="server" Font-Bold="True" Font-Size="Large" 
                Height="57px" onclick="cmdDisplay_Click" style="margin-left: 15px" Text="Show" 
            ...
            <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
                ...
                EmptyDataText="No Records Found..." GridLines="Horizontal" Height="35px" 
                style="text-align: center; margin-left: 168px;" Width="266px">
                ...
                <Fields>
                    ...
                    <asp:BoundField DataField="sAadhar" HeaderText="sAadhar" 
                        SortExpression="sAadhar" />
                    <asp:BoundField DataField="address" HeaderText="address" 
                        SortExpression="address" />
                    <asp:BoundField DataField="phoneno" HeaderText="phoneno" 
                        SortExpression="phoneno" />
                    <asp:BoundField DataField="bankacc" HeaderText="bankacc" 
