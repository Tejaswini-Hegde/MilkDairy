<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SpecificReceipt.aspx.cs" Inherits="SpecificReceipt" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="X-Large" 
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" BackColor="White" 
            ...
            <Fields>
                <asp:BoundField DataField="rTRN" HeaderText="rTRN" InsertVisible="False" 
                ...
                <asp:BoundField DataField="rAmt" HeaderText="rAmt" SortExpression="rAmt" />
